...
export const metadata: Metadata = {
  title: 'Product Details | Digital Health Marketplace',
  description: 'View detailed information about digital therapeutic programs and wellness resources.',
};
...
const ProductPage: React.FC<{ params: { productId: string } }> = async ({ params }) => {
  ...
  try {
    product = await MarketplaceAPI.getProductById(params.productId);
  } catch (error) {
    notFound();
  }
