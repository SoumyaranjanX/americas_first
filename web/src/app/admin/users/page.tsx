...
import { useAuditLog } from '../../../lib/utils/audit';
...
const UsersPage: React.FC = () => {
  ...
  const modalActions: ClinicalAction[] = useMemo(() => [
    {
      label: 'Update',
      onClick: async () => {
        if (selectedUser) {
          await handleUserUpdate(selectedUser.id, selectedUser);
        }
      },
      variant: 'primary',
