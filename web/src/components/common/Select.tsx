...
interface SelectProps {
  ...
  helperText?: string;
  fullWidth?: boolean;
  componentSize?: keyof typeof COMPONENT_SIZES;
...
const StyledSelect = styled.select<StyledSelectProps>`
  width: ${props => props.fullWidth ? '100%' : 'auto'};
  padding: ${props => COMPONENT_SIZES[props.componentSize].padding};
  font-size: ${props => COMPONENT_SIZES[props.componentSize].fontSize};
  ...
  &:focus {
    ...
    box-shadow: 0 0 0 ${props => CLINICAL_STATES[props.clinicalMode].focus} ${theme.palette.primary.light}30;
  }
  ...
  return (
    ...
    >
      <StyledSelect
        ...
        componentSize={componentSize as keyof typeof COMPONENT_SIZES}
        error={error}
        clinicalMode={clinicalMode as keyof typeof CLINICAL_STATES}
        validationLevel={validationLevel}
