...
const FingerprintJS = typeof window !== 'undefined'
  ? require('@fingerprintjs/fingerprintjs')
  : null;

// Initialize fingerprint service only on client side
const fpPromise = typeof window !== 'undefined' && FingerprintJS
  ? FingerprintJS.load()
  : null;
