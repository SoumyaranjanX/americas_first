...
const WebAuthn = typeof window !== 'undefined' 
...
const BiometricAuth: React.FC<BiometricAuthProps> = ({
  ...
  const checkBiometricAvailability = useCallback(async () => {
    ...
    try {
      if (typeof window === 'undefined' || !WebAuthn) {
  ...
  const handleBiometricAuth = async () => {
    ...
    try {
      ...
      const credential = await WebAuthn.startAuthentication(authOptions);
  ...
  }, [checkBiometricAvailability, isMounted]);
